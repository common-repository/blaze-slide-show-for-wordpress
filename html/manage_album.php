...
?>
<?php if(isset($gblz->messages['upload']) && is_array($gblz->messages['upload']) && count($gblz->messages['upload']) > 0): ?>
<div class="updated">
<p class="">
<?php foreach($gblz->messages['upload'] as $msg): ?>
	<span><?php print $msg; ?></span><br/>
<?php endforeach;?>
</p>
</div>
<?php endif; ?>
<script type="text/javascript">var blaze_current_album_id = <?php print $album['album_id']; ?>;</script>
<div class="dataTable_wrapper">
	<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
		...
		<?php blaze_get_table_actions(array('blaze_bulk_delete_images' => 'Delete', 
											'blaze_bulk_disable_images' => 'Disable', 
											'blaze_bulk_enable_images' => 'Enable')); ?>
	</div>
	...
	<tbody>
	<?php require_once BLZ_PLUGIN_DIR . '/html/images_rows.php'; ?>
	</tbody>
	</table>
...
<div id="single_upload" class="tab_content">
	<form id="single_upload_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="blaze_single_image_upload" />
...
-->
	...
	var blaze_upload_dir = "<?php  /* add the replace "\\" to work on windows server */  print str_replace("\\","/",blaze_get_album_dir($album['album_id'])); ?>";
	var blaze_secw = "<?php 
	global $wpdb;
	$query = "SELECT txt FROM {$wpdb->prefix}blaze_misc WHERE ione=1 AND itwo=1 AND ithree=1 LIMIT 1";
